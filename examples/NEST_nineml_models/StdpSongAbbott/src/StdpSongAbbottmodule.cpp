/* This file was generated by PyPe9 version 0.2 on Thu 29 Apr 21 05:40:30PM */
...
mynest::StdpSongAbbottModule StdpSongAbbottmodule_LTX_mod;
#endif

// -- DynModule functions ------------------------------------------------------

mynest::StdpSongAbbottModule::StdpSongAbbottModule() {
#ifdef LINKED_MODULE
...
const std::string
mynest::StdpSongAbbottModule::name(void) const {
    return std::string("PyPe9-generated module for StdpSongAbbott class"); // Return name of the module
}

const std::string
mynest::StdpSongAbbottModule::commandstring(void) const {
...
void mynest::StdpSongAbbottModule::init( SLIInterpreter* i )
{
